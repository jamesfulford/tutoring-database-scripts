...
set underline =
	...
	spool C:\Users\James\Desktop\Oracle\tutoringSchema\radiosilence\reports/contactsByID.txt
...
SELECT FIRSTNAME, LASTNAME, PHONE NUMBER, EMAILADDRESS FROM contacts ORDER BY CONTACT_ID;
