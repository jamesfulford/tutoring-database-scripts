...
set underline =
	...
	spool C:\Users\James\Desktop\Oracle\tutoringSchema\radiosilence\reports/contactsByFirstName.txt
...
SELECT FIRSTNAME, LASTNAME, PHONENUMBER, EMAILADDRESS FROM contacts ORDER BY FIRSTNAME;
